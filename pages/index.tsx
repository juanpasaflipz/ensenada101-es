...
const Home: NextPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitted(true);
    setShowPopup(true);
    window.location.href = `mailto:hello@ensenada101.com?subject=Notif%C3%ADcame&body=Hola!%20Agr%C3%A9game%20a%20la%20lista.%20Mi%20email%3A%20${encodeURIComponent(email)}`;
    setEmail("");
  };
      ...
      {showPopup && (
        ...
        >
          ...
          >
            ...
            <p className="text-2xl font-bold text-white font-display uppercase">Ya est&aacute;s en la lista.</p>
